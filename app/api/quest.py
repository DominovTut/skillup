...
@router.get('/quest/{quest_id}', status_code=status.HTTP_200_OK, response_model=quest_schema.GetQuestModel)
def get_quest(quest_id: int):
    return quest_schema.GetQuestModel.model_validate(quest_service.fetch_quest(quest_id))